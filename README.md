...
| Which instrument formats are actually verified, and which are assumed | [Vendor formats](docs/VENDOR_FORMATS.md) |
| Whether a Thermo `.raw` file has been truncated | [Thermo RAW validation](docs/THERMO_RAW_VALIDATION.md), and [`thermoraw-check`](src/PanoramaBridge.ThermoRaw/README.md), a standalone tool published with each release |
