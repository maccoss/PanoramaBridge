...
from panoramabridge import FileProcessor, MainWindow
...
class TestSimplifiedProgressMessages:
    ...
    def test_no_percentage_in_status_messages(self):
        ...
        old_confusing_patterns = ["73%", "halfway", "nearly done", "(41%)", "91%"]

        # Test the new simplified messages
        new_status_messages = ["Preparing upload...", "Uploading file...", "Upload complete"]
