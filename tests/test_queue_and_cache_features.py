...
class TestQueueTableIntegration:
    ...
    def mock_main_window(self):
        ...
        mock_window.add_queued_file_to_table = panoramabridge.MainWindow.add_queued_file_to_table.__get__(mock_window)
    ...
    def test_add_queued_file_progress_bar_hidden(self, mock_table_item, mock_progress_bar, mock_main_window):
        ...
        mock_progress_instance.setVisible.assert_called_with(False)  # Should be hidden for queued files
...
class TestPersistentChecksumCaching:
    ...
    def test_save_config_includes_checksum_cache(self, mock_file, mock_json_dump, mock_mkdir, mock_main_window_with_cache):
    ...
    @patch('json.dump')  
    @patch('builtins.open', new_callable=mock_open)
    def test_save_config_empty_cache(self, mock_file, mock_json_dump, mock_mkdir, mock_main_window_with_cache):
    ...
    @patch('json.dump')
    @patch('builtins.open', new_callable=mock_open)
    def test_save_checksum_cache_method(self, mock_file, mock_json_dump, mock_mkdir, mock_main_window_with_cache):
    ...
    def test_save_checksum_cache_empty_cache(self, mock_main_window_with_cache):
        ...
        mock_main_window_with_cache.save_checksum_cache = panoramabridge.MainWindow.save_checksum_cache.__get__(mock_main_window_with_cache)
