# PanoramaBridge v26.6.0 Release Notes

Every message about a file that is waiting now says what it is waiting for, and what you can do
about it. Several said nothing useful, and a few named buttons and settings that would not move
the file — one showed a programmer's error with a parameter name in it. Nothing about how files
are found, sent or verified has changed.
