# PanoramaBridge v26.4.0 Release Notes

A file held because something different already occupies its destination can now be decided about,
from the **Uploads** tab, instead of waiting indefinitely for a decision there was no way to make.
